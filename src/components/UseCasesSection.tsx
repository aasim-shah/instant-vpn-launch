      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
          {useCases.map((useCase) => (
            <div
              key={useCase.title}
              className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 p-8 backdrop-blur-sm transition-all duration-300 hover:border-foreground/15 hover:shadow-xl"
            >
