  ...
  return (
    <>
      <SEO 
        ...
        canonical="/sdk/docs/v2/server-discovery"
      />
...
sdk.<span className="fn">clearCache</span>()</code></pre>
        ...
        <PageNav 
          prev={{ href: '/sdk/docs/v2/getting-started', title: 'Getting Started' }}
          next={{ href: '/sdk/docs/v2/connection-lifecycle', title: 'Connection Lifecycle' }} 
        />
      </SDKDocsLayout>
    </>
  );
