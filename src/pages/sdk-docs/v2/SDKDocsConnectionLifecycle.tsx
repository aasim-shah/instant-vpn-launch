  ...
  return (
    <>
      <SEO 
        ...
        canonical="/sdk/docs/v2/connection-lifecycle"
      />
...
{'}'}</code></pre>
        ...
        <PageNav 
          prev={{ href: '/sdk/docs/v2/server-discovery', title: 'Server Discovery' }}
          next={{ href: '/sdk/docs/v2/smart-connect', title: 'Smart Connect' }} 
        />
      </SDKDocsLayout>
    </>
  );
