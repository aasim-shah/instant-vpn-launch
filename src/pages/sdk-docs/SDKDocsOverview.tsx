    ...
    <>
      ...
      <SDKDocsLayout title="Overview">
        ...
        <p className="sdk-page-description">
          <Badge>SDK v1.1.0</Badge> &nbsp;·&nbsp; Last Updated: March 2026 &nbsp;·&nbsp; Min Android: API 21
        </p>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Browse, filter, and search VPN servers by country, city, region, or protocol</td>
            </tr>
            <tr>
              <td><strong>Smart Connect</strong></td>
              <td>One-call optimal server selection with strategies for streaming, P2P, low latency, and more</td>
            </tr>
            <tr>
