  ...
  return (
    <>
      ...
      <SDKDocsLayout title="Overview">
        ...
        <p>All three protocols are first-class citizens throughout the SDK — from server filtering to profile creation to connection reporting. The Amnezia constant (<code>VpnProtocol.AMNEZIA</code>) also covers backend variants such as <code>"amneziawg-v20"</code>, which the SDK normalizes automatically during protocol parsing.</p>
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td><Link to="/sdk/docs/v3/whats-new">What's New — April 2026</Link></td>
              <td>Full changelog and migration guide for SDK v1.2.0</td>
            </tr>
            <tr>
              <td><Link to="/sdk/docs/v3/getting-started">Getting Started</Link></td>
              <td>Install, configure, activate your first device</td>
            </tr>
            <tr>
              <td><Link to="/sdk/docs/v3/server-discovery">Server Discovery</Link></td>
              <td>Browse servers, filter by location/protocol, use caching</td>
            </tr>
            <tr>
              <td><Link to="/sdk/docs/v3/connection-lifecycle">Connection Lifecycle</Link></td>
              <td>End-to-end connect → use → disconnect flow</td>
            </tr>
            <tr>
              <td><Link to="/sdk/docs/v3/smart-connect">Smart Connect</Link></td>
              <td>One-call server selection with strategies</td>
            </tr>
            <tr>
              <td><Link to="/sdk/docs/v3/error-handling">Error Handling</Link></td>
              <td>VpnResult pattern, exception types, retry logic</td>
            </tr>
            <tr>
              <td><Link to="/sdk/docs/v3/ui-utilities">UI Utilities</Link></td>
              <td>Display models, providers, formatters for fast UI building</td>
            </tr>
            <tr>
              <td><Link to="/sdk/docs/v3/configuration">Configuration Reference</Link></td>
        ...
        <PageNav 
          next={{ href: '/sdk/docs/v3/whats-new', title: "What's New" }} 
        />
      </SDKDocsLayout>
    </>
  );
