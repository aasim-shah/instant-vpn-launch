  ...
  return (
    <>
      <SEO 
        ...
        canonical="/sdk/docs/v3/ui-utilities"
      />
      <SDKDocsLayout title="UI Utilities">
        ...
        <p>
          Build the same flows using the public APIs — <code>getServers()</code>, <code>getCountries()</code>, <code>getCities()</code>, <code>smartConnect()</code> —
          then pass the results through the utility and extension functions below to get UI-ready models.
        </p>
...
{'}'}</code></pre>
        ...
        <PageNav 
          prev={{ href: '/sdk/docs/v3/error-handling', title: 'Error Handling' }}
          next={{ href: '/sdk/docs/v3/configuration', title: 'Configuration' }} 
        />
      </SDKDocsLayout>
    </>
  );
