  ...
  return (
    <>
      ...
      <SDKDocsLayout title="What's New">
        ...
        <h2>Updated note — version mismatch warning</h2>
        <p>
          This page is written as a <code>v1.2.0</code> release note. In the SDK source code included in this repository, the Gradle module version is
          <code>1.1.1</code> (<code>fyreway-vpn-sdk/build.gradle.kts</code>) and <code>FyreWaySDK.VERSION</code> is <code>"1.1.0-alpha"</code>
          (<code>fyreway-vpn-sdk/src/main/kotlin/com/fyreway/vpn/sdk/FyreWaySDK.kt</code>).
        </p>
        <p>
          <strong>Needs manual verification:</strong> confirm which SDK version these release notes are meant to document, and whether the repo source has diverged
          from the published artifact that this website targets.
        </p>
