  ...
  return (
    <>
      <SEO 
        ...
        canonical="/sdk/docs/error-handling"
      />
...
{'}'}</code></pre>
        ...
        <ul>
          ...
          <li>
            <strong>Play Integrity prerequisites</strong>: Play Integrity mode requires Android <code>Context</code> and the Play Integrity dependency in the app. If the dependency is missing, the SDK will surface an error indicating Play Integrity is unavailable.
          </li>
        </ul>
        <p>
          <strong>Needs manual verification:</strong> exact backend error codes/messages for Layer 0 failures and the required distribution model (Google Play vs sideload) for Play Integrity.
        </p>
...
{'}'}</code></pre>
        ...
        <PageNav 
          prev={{ href: '/sdk/docs/smart-connect', title: 'Smart Connect' }}
          next={{ href: '/sdk/docs/ui-utilities', title: 'UI Utilities' }} 
        />
      </SDKDocsLayout>
    </>
  );
